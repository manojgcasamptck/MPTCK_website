...
const faqResponses: Record<string, string> = {
  admission: `Admissions are through POLYCAP portal (polycap.kerala.gov.in). Eligibility: SSLC pass for !st year admission and +2 Science/Computer/VHSC for the direct admission to second year(LET).Contact: ${siteConfig.phone}`,
  course: `We offer 6 diploma programs: ${departments.map((d) => d.short).join(", ")}. Visit /admissions/courses for details.`,
  placement: "MPTC has 100%+ placement rate. 515 offers in 2025-26 from 90+ companies. Highest package: ₹4 LPA.",
...
export default function Chatbot() {
  ...
  const [messages, setMessages] = useState<ChatMessage[]>([
    { role: "bot", text: "Hello! I'm Mitra, your asistant to help you about admissions, courses, placements, or contact details." },
  ]);
